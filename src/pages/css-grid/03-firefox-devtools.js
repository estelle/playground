...
const Tutorial = () => (
  <div>
    <VideoPlayer videoId="vlXGVXY7N-0" />
    ...
    <p>
      The new “Display grid areas” setting shows the bounding areas and the
      associated area name in every cell. We'll learn more about how to set a
      grid area name in a bit.
    </p>
    <img style={imgStyle} src={gif3} alt="grid area" />

    <h3>Visualize transformations</h3>
    <p>
      The Grid Inspector is capable of visualizing transformations applied to
      the grid container. This lets you accurately see where the grid lines are
      on the page for any grids that are translated, skewed, rotated, or scaled.
    </p>
